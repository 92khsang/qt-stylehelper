...
if TYPE_CHECKING:
    from qt_stylehelper.themes.models import ExtraAttribute, Theme

ICON_PREFIX: str = "icon"
ICON_URL_PREFIX: str = f"{ICON_PREFIX}:/"
...
class StyleSheetRenderer:
    ...
    def __init__(self, template_file: str = str(ResourcePathUtils.template_file())):
    ...
    def render(self, theme: "Theme", extra: "ExtraAttribute") -> str:
        """
        ...
        Args:
            ...
            extra (ExtraAttribute): Additional attributes for customizing the style.
        ...
        """
        template: jinja2.Template = self._load_template()
        template_inputs = {**theme.to_dict(), **extra.values, **self.__ENVIRONMENT_INFO}
    ...
    def _load_template(self) -> jinja2.Template:
        ...
        env = jinja2.Environment(autoescape=False, loader=loader)  # noqa
