...
class ExtraAttributes:
    ...
    @staticmethod
    def _process_extras(
        extra: Dict[str, Union[str, float, Dict[str, str]]],
    ...
    def with_updated_values(
        self, new_values: Dict[str, Union[str, float, Dict[str, str]]]
    ) -> "ExtraAttributes":
        """
    ...
    def get_value(
        self, key: str, default: Union[str, float, None] = None
