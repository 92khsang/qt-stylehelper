...
class TestContextIconGenerator(unittest.TestCase):
    ...
    def test_process_svg(self, mock_replace_color, mock_open):
        ...
        mock_replace_color.side_effect = (
            lambda content, old_color, new_color: content.replace(old_color, new_color)
        )
    ...
    def test_generate_missing_dirs(self):
        ...
        self.assertEqual(
            ...
            "Both source_dir and destination_dir must be provided.",
        )
